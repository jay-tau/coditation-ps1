...
\chapter{Chapter Title Here and Now} % Main chapter title
...
\section{A Preface for BITSians}
...
This template adheres to the exact document specifications for PS reports as of 2021. The title page, abstract sheet, bibliography and everything in between is generated automatically.

To change your details, refer to the \emph{variables.tex} file. Apart from that, your content belongs to the other tex files (Chapters, Appendices etc.). This template has examples built in for easy adaptation. Please remove any of the placeholder text (lorem ipsum) accordingly.

Hope it's useful. Feel free to reach out for any suggestions or to submit a pull request. Cheers!
